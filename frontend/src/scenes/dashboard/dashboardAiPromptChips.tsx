...
export function DashboardAiPromptChips({
    ...
    className,
    maxChips,
    description = `Pick a topic below. ${BRAND.aiAssistantLabel} does the work so you can look at the data you care about quickly.`,
        ...
        <div className={className}>
            <div className="rounded-xl border-2 border-[var(--color-ai)] bg-bg-surface-primary p-4">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-semibold">Try {BRAND.aiAssistantLabel}</span>
                </div>
